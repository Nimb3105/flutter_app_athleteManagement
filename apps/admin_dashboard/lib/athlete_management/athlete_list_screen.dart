    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create:
              (context) =>
                  AthleteBloc(athleteRepository: RepositoryProvider.of(context))
      ...
      child: Padding(
        ...
        child: BlocConsumer<AthleteBloc, AthleteState>(
          ...
          builder: (context, state) {
            ...
            } else if (state is Athlete_Loading) {
                                        ...
                                        showDialog(
                                          ...
                                          builder:
                                              (context) => AlertDialog(
                                                ...
                                                content: Text(
                                                  'Bạn có chắc muốn xóa vận động viên ${athlete.id}?',
                                                ),
                                                actions: [
                                                  TextButton(
                                                    onPressed:
            ...
            } else if (state is LoadedAthlete) {
              return const Center(
