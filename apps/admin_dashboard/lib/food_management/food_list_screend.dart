                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                      ...
                      rows: foods.isEmpty && state is! Food_Loading
                          ? [
                              const DataRow(cells: [
                                DataCell(
                          ...
                          : foods.map((food) {
                              return DataRow(
                                cells: [
                                  ...
                                  DataCell(Text(formatUtcToLocal(food.createdAt))),
                                  DataCell(Text(formatUtcToLocal(food.updatedAt))),
                                  DataCell(
                                    Row(
