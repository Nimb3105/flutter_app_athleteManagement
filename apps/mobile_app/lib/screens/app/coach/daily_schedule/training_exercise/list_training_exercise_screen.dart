...
//     return AlertDialog(
//       title: Text('Cập nhật kết quả: ${widget.exercise?.name ?? ""}'),
...
//                         decoration: const InputDecoration(
//                           labelText: 'Thời gian đã thực hiện (giây)',
//                         ),
//                         keyboardType: TextInputType.number,
//                         validator: (value) {
//                           if (value == null || value.isEmpty) {
...
//                         decoration: const InputDecoration(
//                           labelText: 'Khoảng cách đã thực hiện (mét)',
//                         ),
//                         keyboardType: TextInputType.number,
//                         validator: (value) {
//                           if (value == null || value.isEmpty) {
...
//               onPressed: () {
//                 // Tạo một bản sao của bài tập với scheduleId là null
...
//                   actualWeight: 0.0,
//                 );
//                 // Gọi sự kiện UpdateTrainingExercise thay vì DeleteTrainingExercise
//                 context.read<TrainingExerciseBloc>().add(
//                   UpdateTrainingExercise(updatedExercise),
//                 );
//                 Navigator.of(dialogContext).pop();
...
//   Widget _buildSubtitle(TrainingExercise trainingExercise, Exercise? exercise) {
//     if (exercise?.unitType == 'Thời gian') {
//       return Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           Text(
//             'Mục tiêu: ${trainingExercise.duration} giây x ${trainingExercise.distance} m x ${trainingExercise.weight} kg ',
//           ),
//           Text(
//             'Hoàn thành: ${trainingExercise.actualDuration} giây x ${trainingExercise.actualDistance} m x ${trainingExercise.actualWeight} kg ',
//           ),
//         ],
//       );
//     } else {
...
//         children: [
//           Text(
//             'Mục tiêu: ${trainingExercise.sets} hiệp x ${trainingExercise.reps} lần x ${trainingExercise.weight} kg',
//           ),
//           Text(
//             'Hoàn thành: ${trainingExercise.actualSets} hiệp x ${trainingExercise.actualReps} lần x ${trainingExercise.actualWeight} kg ',
//           ),
//         ],
//       );
//     }
...
//         label: const Text('Lịch tập đã hủy'),
//       );
//     }

//     switch (trainingExercise.status.toLowerCase()) {
//       case 'đã lên lịch':
//         return ElevatedButton.icon(
//           onPressed:
//               () => _showUpdateDialog(context, trainingExercise, exercise),
//           style: ElevatedButton.styleFrom(backgroundColor: Colors.blue),
//           icon: const Icon(Icons.edit),
//           label: const Text('Ghi nhận kết quả'),
//         );
//       case 'hoàn thành':
//         return ElevatedButton.icon(
//           onPressed:
...
//                     (te) =>
//                         _calculateProgress(te, exerciseDetails?[te.exerciseId]),
//                   );
//                   totalProgress =
...
//               length = state.trainingExercises.length;
//             }
//           },
//         ),
...
//                       widget.trainingSchedule.status.toLowerCase() ==
//                       'chưa hoàn thành';
...
//                             MaterialPageRoute(
//                               builder:
//                                   (context) => ExerciseDetailInDailyScreen(
//                                     exercise: exercise,
//                                   ),
//                             ),
//                           );
...
//                             _buildSubtitle(trainingExercise, exercise),
...
//                           title: 'Xác nhận ghi nhận lại',
//                           content:
//                               'Bạn có muốn đặt lại trạng thái lịch tập này không?',
...
//                           title: 'Xác nhận ghi nhận lại',
//                           content:
//                               'Bạn có muốn đặt lại trạng thái và ghi nhận lại kết quả không?',
//                           schedule: widget.trainingSchedule,
//                           exercises: state.trainingExercises,
//                           exerciseDetails: state.exercises,
//                         ),
...
//                           content:
//                               'Bạn có chắc chắn muốn hoàn thành lịch tập này không?',
//                           schedule: widget.trainingSchedule,
//                           exercises: state.trainingExercises,
//                           exerciseDetails: state.exercises,
//                         ),
