...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetAllSports);
}
...
@override
String toString() {
  return 'SportEvent.getAllSports()';
}
...
class LoadedSports implements SportState {
  const LoadedSports(final  List<Sport> sports): _sports = sports;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadedSports&&const DeepCollectionEquality().equals(other._sports, _sports));
}
...
@override
String toString() {
  return 'SportState.loadedSports(sports: $sports)';
}
