...
sealed class CoachCertificationEvent with _$CoachCertificationEvent {
  const factory CoachCertificationEvent.createCoachCertification(CoachCertification certification) = _CreateCoachCertification;
  const factory CoachCertificationEvent.getCoachCertificationById(String id) = _GetCoachCertificationById;
  const factory CoachCertificationEvent.getCoachCertificationByUserId(String userId) = _GetCoachCertificationByUserId;
  const factory CoachCertificationEvent.getAllCoachCertifications({
    @Default(1) int page,
    @Default(10) int limit,
  }) = _GetAllCoachCertifications;
  const factory CoachCertificationEvent.updateCoachCertification(String id, CoachCertification certification) = _UpdateCoachCertification;
  const factory CoachCertificationEvent.deleteCoachCertification(String id) = _DeleteCoachCertification;
}
...
sealed class CoachCertificationState with _$CoachCertificationState {
  ...
  const factory CoachCertificationState.loadedCoachCertification(CoachCertification certification) = LoadedCoachCertification;
  ...
  const factory CoachCertificationState.error(String message) = CoachCertification_Error;
  const factory CoachCertificationState.success(String message) = CoachCertification_Success;
}

class CoachCertificationBloc extends Bloc<CoachCertificationEvent, CoachCertificationState> {
  ...
  Future<void> _onCreateCoachCertification(
    ...
    try {
      final createdCertification = await coachCertificationRepository.createCoachCertification(event.certification);
      emit(CoachCertificationState.loadedCoachCertification(createdCertification));
    } catch (e) {
  ...
  Future<void> _onGetCoachCertificationById(
    ...
    emit(const CoachCertificationState.loading());
    try {
      final certification = await coachCertificationRepository.getCoachCertificationById(event.id);
  ...
  Future<void> _onGetCoachCertificationByUserId(
    ...
    emit(const CoachCertificationState.loading());
    try {
      final certification = await coachCertificationRepository.getCoachCertificationByUserId(event.userId);
      emit(CoachCertificationState.loadedCoachCertification(certification));
    } catch (e) {
      emit(CoachCertificationState.error(e.toString()));
    }
  ...
  Future<void> _onGetAllCoachCertifications(
    ...
    emit(const CoachCertificationState.loading());
    try {
      final result = await coachCertificationRepository.getAllCoachCertifications(
        page: event.page,
        limit: event.limit,
      );
      emit(
  ...
  Future<void> _onUpdateCoachCertification(
    ...
    emit(const CoachCertificationState.loading());
    try {
      final updatedCertification = await coachCertificationRepository.updateCoachCertification(
        event.id,
        event.certification,
      );
      emit(CoachCertificationState.loadedCoachCertification(updatedCertification));
    } catch (e) {
      emit(CoachCertificationState.error(e.toString()));
    }
  }
  ...
  Future<void> _onDeleteCoachCertification(
    ...
    try {
      ...
      emit(const CoachCertificationState.success('Coach certification deleted successfully'));
    } catch (e) {
      emit(CoachCertificationState.error(e.toString()));
    }
  }
