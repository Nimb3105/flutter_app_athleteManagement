...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? userId,  String? scheduleId,  String? nutritionPlanId, @UtcDateTimeConverter()  DateTime reminderTime, @UtcDateTimeConverter()  DateTime reminderDate,  String content,  String status, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Reminder() when $default != null:
return $default(_that.id,_that.userId,_that.scheduleId,_that.nutritionPlanId,_that.reminderTime,_that.reminderDate,_that.content,_that.status,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? userId,  String? scheduleId,  String? nutritionPlanId, @UtcDateTimeConverter()  DateTime reminderTime, @UtcDateTimeConverter()  DateTime reminderDate,  String content,  String status, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Reminder():
return $default(_that.id,_that.userId,_that.scheduleId,_that.nutritionPlanId,_that.reminderTime,_that.reminderDate,_that.content,_that.status,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? userId,  String? scheduleId,  String? nutritionPlanId, @UtcDateTimeConverter()  DateTime reminderTime, @UtcDateTimeConverter()  DateTime reminderDate,  String content,  String status, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Reminder() when $default != null:
return $default(_that.id,_that.userId,_that.scheduleId,_that.nutritionPlanId,_that.reminderTime,_that.reminderDate,_that.content,_that.status,_that.createdAt,_that.updatedAt);case _:
  return null;
