...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String location,  String name,  String description,  String organizer,  String level, @UtcDateTimeConverter()  DateTime startDate, @UtcDateTimeConverter()  DateTime endDate, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Tournament() when $default != null:
return $default(_that.id,_that.location,_that.name,_that.description,_that.organizer,_that.level,_that.startDate,_that.endDate,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String location,  String name,  String description,  String organizer,  String level, @UtcDateTimeConverter()  DateTime startDate, @UtcDateTimeConverter()  DateTime endDate, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Tournament():
return $default(_that.id,_that.location,_that.name,_that.description,_that.organizer,_that.level,_that.startDate,_that.endDate,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String location,  String name,  String description,  String organizer,  String level, @UtcDateTimeConverter()  DateTime startDate, @UtcDateTimeConverter()  DateTime endDate, @UtcDateTimeConverter()  DateTime createdAt, @UtcDateTimeConverter()  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Tournament() when $default != null:
return $default(_that.id,_that.location,_that.name,_that.description,_that.organizer,_that.level,_that.startDate,_that.endDate,_that.createdAt,_that.updatedAt);case _:
  return null;
